...
static inline BOOL __IsIPhoneXSeries() {
...
#define kTopH (__IsIPhoneXSeries()?88:64)
...
- (void)setInitDefSubviewsFlag:(BOOL)initDefSubviewsFlag {
    ...
    if (_initDefSubviewsFlag) {
        ...
        self._v1.frame = CGRectMake(0, kTopH, self.view.bounds.size.width*0.5, 200);
        self._v2.frame = CGRectMake(self.view.bounds.size.width*0.5, kTopH, self.view.bounds.size.width*0.5, 200);
        ...
        __cusV.frame = CGRectMake(0, CGRectGetMaxY(self._txtF01.frame),
                                  __v1.bounds.size.width,
                                  __v1.bounds.size.height-CGRectGetMaxY(self._txtF01.frame));
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    __txtF01.text = _adspotIdsArr[indexPath.row][@"adspotId"];
}
