 ...
 * each chunk.  Please see the BY_HTTPAsyncFileResponse class for an example of how to do this.
 * 
 ...
 * 
 * First the BY_HTTPResponse is given the opportunity to postpone sending the HTTP response headers.
 ...
 * In situations such as this, the BY_HTTPResponse simply implements the delayResponseHeaders method and returns YES.
