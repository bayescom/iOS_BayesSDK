...
/**
 * This is an asynchronous version of BY_HTTPFileResponse.
 ...
 * An example of this is the BY_HTTPDynamicFileResponse class.
**/

@interface BY_HTTPAsyncFileResponse : NSObject <BY_HTTPResponse>
{	
