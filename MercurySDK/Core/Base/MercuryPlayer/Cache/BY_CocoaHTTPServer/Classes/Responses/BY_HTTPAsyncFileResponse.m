...
@implementation BY_HTTPAsyncFileResponse

- (id)initWithFilePath:(NSString *)fpath forConnection:(BY_HTTPConnection *)parent
{
	if ((self = [super init]))
	{
		HTTPLogTrace();
...
- (void)processReadBuffer
{
	...
	// For an example, see the BY_HTTPDynamicFileResponse class.
	// 
...
- (BOOL)openFileAndSetupReadSource
{
	...
	readQueue = dispatch_queue_create("BY_HTTPAsyncFileResponse", NULL);
