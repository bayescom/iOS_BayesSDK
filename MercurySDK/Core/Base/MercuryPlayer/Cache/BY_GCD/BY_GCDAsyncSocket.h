...
@class BY_GCDAsyncReadPacket;
@class BY_GCDAsyncWritePacket;
@class BY_GCDAsyncSocketPreBuffer;
@protocol BY_GCDAsyncSocketDelegate;

NS_ASSUME_NONNULL_BEGIN

extern NSString *const BY_GCDAsyncSocketException;
extern NSString *const BY_GCDAsyncSocketErrorDomain;

extern NSString *const BY_GCDAsyncSocketQueueName;
extern NSString *const BY_GCDAsyncSocketThreadName;

extern NSString *const BY_GCDAsyncSocketManuallyEvaluateTrust;
#if TARGET_OS_IPHONE
extern NSString *const BY_GCDAsyncSocketUseCFStreamForTLS;
#endif
#define BY_GCDAsyncSocketSSLPeerName     (NSString *)kCFStreamSSLPeerName
#define BY_GCDAsyncSocketSSLCertificates (NSString *)kCFStreamSSLCertificates
#define BY_GCDAsyncSocketSSLIsServer     (NSString *)kCFStreamSSLIsServer
extern NSString *const BY_GCDAsyncSocketSSLPeerID;
extern NSString *const BY_GCDAsyncSocketSSLProtocolVersionMin;
extern NSString *const BY_GCDAsyncSocketSSLProtocolVersionMax;
extern NSString *const BY_GCDAsyncSocketSSLSessionOptionFalseStart;
extern NSString *const BY_GCDAsyncSocketSSLSessionOptionSendOneByteRecord;
extern NSString *const BY_GCDAsyncSocketSSLCipherSuites;
#if !TARGET_OS_IPHONE
extern NSString *const BY_GCDAsyncSocketSSLDiffieHellmanParameters;
#endif

#define BY_GCDAsyncSocketLoggingContext 65535


typedef NS_ENUM(NSInteger, BY_GCDAsyncSocketError) {
	BY_GCDAsyncSocketNoError = 0,           // Never used
	BY_GCDAsyncSocketBadConfigError,        // Invalid configuration
	BY_GCDAsyncSocketBadParamError,         // Invalid parameter was passed
	BY_GCDAsyncSocketConnectTimeoutError,   // A connect operation timed out
	BY_GCDAsyncSocketReadTimeoutError,      // A read operation timed out
	BY_GCDAsyncSocketWriteTimeoutError,     // A write operation timed out
	BY_GCDAsyncSocketReadMaxedOutError,     // Reached set maxLength without completing
	BY_GCDAsyncSocketClosedError,           // The remote peer closed the connection
	BY_GCDAsyncSocketOtherError,            // Description provided in userInfo
};
...
@interface BY_GCDAsyncSocket : NSObject

/**
 * BY_GCDAsyncSocket uses the standard delegate paradigm,
 ...
 * If you pass NULL, BY_GCDAsyncSocket will automatically create it's own socket queue.
...
- (instancetype)initWithDelegate:(nullable id<BY_GCDAsyncSocketDelegate>)aDelegate delegateQueue:(nullable dispatch_queue_t)dq;
- (instancetype)initWithDelegate:(nullable id<BY_GCDAsyncSocketDelegate>)aDelegate delegateQueue:(nullable dispatch_queue_t)dq socketQueue:(nullable dispatch_queue_t)sq;

/**
 * Create BY_GCDAsyncSocket from already connect BSD socket file descriptor
**/
...
+ (nullable instancetype)socketFromConnectedSocketFD:(int)socketFD delegate:(nullable id<BY_GCDAsyncSocketDelegate>)aDelegate delegateQueue:(nullable dispatch_queue_t)dq socketQueue:(nullable dispatch_queue_t)sq error:(NSError **)error;

#pragma mark Configuration

@property (atomic, weak, readwrite, nullable) id<BY_GCDAsyncSocketDelegate> delegate;
...
- (void)getDelegate:(id<BY_GCDAsyncSocketDelegate> __nullable * __nullable)delegatePtr delegateQueue:(dispatch_queue_t __nullable * __nullable)delegateQueuePtr;
- (void)setDelegate:(nullable id<BY_GCDAsyncSocketDelegate>)delegate delegateQueue:(nullable dispatch_queue_t)delegateQueue;
...
**/
- (void)synchronouslySetDelegate:(nullable id<BY_GCDAsyncSocketDelegate>)delegate;
- (void)synchronouslySetDelegateQueue:(nullable dispatch_queue_t)delegateQueue;
- (void)synchronouslySetDelegate:(nullable id<BY_GCDAsyncSocketDelegate>)delegate delegateQueue:(nullable dispatch_queue_t)delegateQueue;

/**
 * By default, both IPv4 and IPv6 are enabled.
 * 
 * For accepting incoming connections, this means BY_GCDAsyncSocket automatically supports both protocols,
 * and can simulataneously accept incoming connections on either protocol.
 * 
 * For outgoing connections, this means BY_GCDAsyncSocket can connect to remote hosts running either protocol.
 * If a DNS lookup returns only IPv4 results, BY_GCDAsyncSocket will automatically use IPv4.
 * If a DNS lookup returns only IPv6 results, BY_GCDAsyncSocket will automatically use IPv6.
 ...
 * When a connection is accepted, a new instance of BY_GCDAsyncSocket will be spawned to handle it,
 ...
 * 
 * Please note the recommended way of releasing a BY_GCDAsyncSocket instance (e.g. in a dealloc method)
 ...
 * it is treated similarly to a timeout - the socket is closed with a BY_GCDAsyncSocketReadMaxedOutError.
 ...
 * This is due to the fact that BY_GCDAsyncSocket does NOT copy the data. It simply retains it.
 ...
 * 
 * - BY_GCDAsyncSocketManuallyEvaluateTrust
 ...
 *     So BY_GCDAsyncSocket will invoke the delegate method socket:shouldTrustPeer: passing the SecTrustRef.
 *
 ...
 *
 * - BY_GCDAsyncSocketUseCFStreamForTLS (iOS only)
 *     The value must be of type NSNumber, encapsulating a BOOL value.
 *     By default BY_GCDAsyncSocket will use the SecureTransport layer to perform encryption.
 ...
 *     
 *     However, if you absolutely must, you can instruct BY_GCDAsyncSocket to use the old-fashioned encryption
 *     technique by going through the CFStream instead. So instead of using SecureTransport, BY_GCDAsyncSocket
 ...
 *     
 *     Thus all the other keys in the given dictionary will be ignored by BY_GCDAsyncSocket,
 ...
 *
 * - BY_GCDAsyncSocketSSLProtocolVersionMin
 * - BY_GCDAsyncSocketSSLProtocolVersionMax
 ...
 * 
 * - BY_GCDAsyncSocketSSLSessionOptionFalseStart
 *     The value must be of type NSNumber, encapsulating a BOOL value.
 *     See Apple's documentation for kSSLSessionOptionFalseStart.
 * 
 * - BY_GCDAsyncSocketSSLSessionOptionSendOneByteRecord
 *     The value must be of type NSNumber, encapsulating a BOOL value.
 *     See Apple's documentation for kSSLSessionOptionSendOneByteRecord.
 * 
 * - BY_GCDAsyncSocketSSLCipherSuites
 ...
 *
 * - BY_GCDAsyncSocketSSLDiffieHellmanParameters (Mac OS X only)
 *     The value must be of type NSData.
 ...
 *     You MUST use manual trust evaluation instead (see BY_GCDAsyncSocketManuallyEvaluateTrust).
 ...
 *     You MUST use BY_GCDAsyncSocketSSLProtocolVersionMin & BY_GCDAsyncSocketSSLProtocolVersionMin instead.
...
/**
 * BY_GCDAsyncSocket maintains thread safety by using an internal serial dispatch_queue.
 ...
 * - (dispatch_queue_t)newSocketQueueForConnectionFromAddress:(NSData *)address onSocket:(BY_GCDAsyncSocket *)sock
 * {
 ...
 *     return socketQueue;
 * }
 * - (void)socket:(BY_GCDAsyncSocket *)sock didAcceptNewSocket:(BY_GCDAsyncSocket *)newSocket
 * {
 ...
 * Example usage:
 * 
 * - (void)socket:(BY_GCDAsyncSocket *)sock didConnectToHost:(NSString *)host port:(uint16_t)port
 * {
...
@protocol BY_GCDAsyncSocketDelegate <NSObject>
@optional
...
**/
- (nullable dispatch_queue_t)newSocketQueueForConnectionFromAddress:(NSData *)address onSocket:(BY_GCDAsyncSocket *)sock;
 ...
 * The host parameter will be an IP address, not a DNS name.
 **/
- (void)socket:(BY_GCDAsyncSocket *)sock didConnectToUrl:(NSURL *)url;

/**
 * Called when a socket has completed reading the requested data into memory.
 * Not called if there is an error.
**/
- (void)socket:(BY_GCDAsyncSocket *)sock didReadData:(NSData *)data withTag:(long)tag;
...
**/
- (void)socket:(BY_GCDAsyncSocket *)sock didReadPartialDataOfLength:(NSUInteger)partialLength tag:(long)tag;

/**
 * Called when a socket has completed writing the requested data. Not called if there is an error.
**/
- (void)socket:(BY_GCDAsyncSocket *)sock didWriteDataWithTag:(long)tag;

/**
 * Called when a socket has written some data, but has not yet completed the entire write.
 * It may be used to for things such as updating progress bars.
**/
- (void)socket:(BY_GCDAsyncSocket *)sock didWritePartialDataOfLength:(NSUInteger)partialLength tag:(long)tag;
...
**/
- (NSTimeInterval)socket:(BY_GCDAsyncSocket *)sock shouldTimeoutReadWithTag:(long)tag
...
**/
- (NSTimeInterval)socket:(BY_GCDAsyncSocket *)sock shouldTimeoutWriteWithTag:(long)tag
                                                                  elapsed:(NSTimeInterval)elapsed
                                                                bytesDone:(NSUInteger)length;
...
**/
- (void)socketDidCloseReadStream:(BY_GCDAsyncSocket *)sock;
 ...
 * 
 * Note: If the BY_GCDAsyncSocket instance is deallocated while it is still connected,
...
**/
- (void)socketDidDisconnect:(BY_GCDAsyncSocket *)sock withError:(nullable NSError *)err;
...
**/
- (void)socket:(BY_GCDAsyncSocket *)sock didReceiveTrust:(SecTrustRef)trust
