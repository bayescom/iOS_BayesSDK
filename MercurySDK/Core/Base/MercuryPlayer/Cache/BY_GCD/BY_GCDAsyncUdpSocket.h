...
extern NSString *const BY_GCDAsyncUdpSocketException;
extern NSString *const BY_GCDAsyncUdpSocketErrorDomain;

extern NSString *const BY_GCDAsyncUdpSocketQueueName;
extern NSString *const BY_GCDAsyncUdpSocketThreadName;

typedef NS_ENUM(NSInteger, BY_GCDAsyncUdpSocketError) {
	BY_GCDAsyncUdpSocketNoError = 0,          // Never used
	BY_GCDAsyncUdpSocketBadConfigError,       // Invalid configuration
	BY_GCDAsyncUdpSocketBadParamError,        // Invalid parameter was passed
	BY_GCDAsyncUdpSocketSendTimeoutError,     // A send operation timed out
	BY_GCDAsyncUdpSocketClosedError,          // The socket was closed
	BY_GCDAsyncUdpSocketOtherError,           // Description provided in userInfo
};
...
@class BY_GCDAsyncUdpSocket;

@protocol BY_GCDAsyncUdpSocketDelegate <NSObject>
@optional
...
**/
- (void)udpSocket:(BY_GCDAsyncUdpSocket *)sock didConnectToAddress:(NSData *)address;
...
**/
- (void)udpSocket:(BY_GCDAsyncUdpSocket *)sock didNotConnect:(NSError * _Nullable)error;

/**
 * Called when the datagram with the given tag has been sent.
**/
- (void)udpSocket:(BY_GCDAsyncUdpSocket *)sock didSendDataWithTag:(long)tag;

/**
 * Called if an error occurs while trying to send a datagram.
 * This could be due to a timeout, or something more serious such as the data being too large to fit in a sigle packet.
**/
- (void)udpSocket:(BY_GCDAsyncUdpSocket *)sock didNotSendDataWithTag:(long)tag dueToError:(NSError * _Nullable)error;

/**
 * Called when the socket has received the requested datagram.
**/
- (void)udpSocket:(BY_GCDAsyncUdpSocket *)sock didReceiveData:(NSData *)data
...
**/
- (void)udpSocketDidClose:(BY_GCDAsyncUdpSocket *)sock withError:(NSError  * _Nullable)error;
 ...
 * Example:
 * 
 * BY_GCDAsyncUdpSocketReceiveFilterBlock filter = ^BOOL (NSData *data, NSData *address, id *context) {
 * 
 ...
 * 
**/
typedef BOOL (^BY_GCDAsyncUdpSocketReceiveFilterBlock)(NSData *data, NSData *address, id __nullable * __nonnull context);
 ...
 *
**/
typedef BOOL (^BY_GCDAsyncUdpSocketSendFilterBlock)(NSData *data, NSData *address, long tag);


@interface BY_GCDAsyncUdpSocket : NSObject

/**
 * BY_GCDAsyncUdpSocket uses the standard delegate paradigm,
 ...
 * If you pass NULL, BY_GCDAsyncSocket will automatically create its own socket queue.
...
- (instancetype)initWithDelegate:(nullable id <BY_GCDAsyncUdpSocketDelegate>)aDelegate delegateQueue:(nullable dispatch_queue_t)dq;
- (instancetype)initWithDelegate:(nullable id <BY_GCDAsyncUdpSocketDelegate>)aDelegate delegateQueue:(nullable dispatch_queue_t)dq socketQueue:(nullable dispatch_queue_t)sq;

#pragma mark Configuration

- (nullable id <BY_GCDAsyncUdpSocketDelegate>)delegate;
- (void)setDelegate:(nullable id <BY_GCDAsyncUdpSocketDelegate>)delegate;
- (void)synchronouslySetDelegate:(nullable id <BY_GCDAsyncUdpSocketDelegate>)delegate;
...
- (void)getDelegate:(id <BY_GCDAsyncUdpSocketDelegate> __nullable * __nullable)delegatePtr delegateQueue:(dispatch_queue_t __nullable * __nullable)delegateQueuePtr;
- (void)setDelegate:(nullable id <BY_GCDAsyncUdpSocketDelegate>)delegate delegateQueue:(nullable dispatch_queue_t)delegateQueue;
- (void)synchronouslySetDelegate:(nullable id <BY_GCDAsyncUdpSocketDelegate>)delegate delegateQueue:(nullable dispatch_queue_t)delegateQueue;

/**
 * By default, both IPv4 and IPv6 are enabled.
 * 
 * This means BY_GCDAsyncUdpSocket automatically supports both protocols,
 * and can send to IPv4 or IPv6 addresses,
 * as well as receive over IPv4 and IPv6.
 * 
 * For operations that require DNS resolution, BY_GCDAsyncUdpSocket supports both IPv4 and IPv6.
 * If a DNS lookup returns only IPv4 results, BY_GCDAsyncUdpSocket will automatically use IPv4.
 * If a DNS lookup returns only IPv6 results, BY_GCDAsyncUdpSocket will automatically use IPv6.
 ...
 * This is due to the fact that BY_GCDAsyncUdpSocket does NOT copy the data.
 ...
 *    or the system tools to handle this aren't available (e.g. on a mobile device).
 * 
 * For more information about BY_GCDAsyncUdpSocketSendFilterBlock, see the documentation for its typedef.
...
**/
- (void)setSendFilter:(nullable BY_GCDAsyncUdpSocketSendFilterBlock)filterBlock withQueue:(nullable dispatch_queue_t)filterQueue;
...
**/
- (void)setSendFilter:(nullable BY_GCDAsyncUdpSocketSendFilterBlock)filterBlock
 ...
 * 
 * Important Note:
 * BY_GCDAsyncUdpSocket may be running in parallel with your code.
 * That is, your delegate is likely running on a separate thread/dispatch_queue.
 * When you invoke this method, BY_GCDAsyncUdpSocket may have already dispatched delegate methods to be invoked.
 ...
 * [udpSocket setReceiveFilter:filter withQueue:myParsingQueue];
 * 
 * For more information about BY_GCDAsyncUdpSocketReceiveFilterBlock, see the documentation for its typedef.
 * To remove a previously set filter, invoke this method and pass a nil filterBlock and NULL filterQueue.
 * 
 * Note: This method invokes setReceiveFilter:withQueue:isAsynchronous: (documented below),
 *       passing YES for the isAsynchronous parameter.
**/
- (void)setReceiveFilter:(nullable BY_GCDAsyncUdpSocketReceiveFilterBlock)filterBlock withQueue:(nullable dispatch_queue_t)filterQueue;
 ...
 * For example, you can't query properties on the socket.
**/
- (void)setReceiveFilter:(nullable BY_GCDAsyncUdpSocketReceiveFilterBlock)filterBlock
               withQueue:(nullable dispatch_queue_t)filterQueue
          isAsynchronous:(BOOL)isAsynchronous;
 ...
 * 
 * The BY_GCDAsyncUdpSocket instance may optionally be used again.
 ...
 * 
 * Generally BY_GCDAsyncUdpSocket doesn't use CFStream. (It uses the faster GCD API's.)
