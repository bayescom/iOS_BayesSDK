...
@class BY_GCDAsyncUdpSendPacket;

NSString *const BY_GCDAsyncUdpSocketException = @"BY_GCDAsyncUdpSocketException";
NSString *const BY_GCDAsyncUdpSocketErrorDomain = @"BY_GCDAsyncUdpSocketErrorDomain";

NSString *const BY_GCDAsyncUdpSocketQueueName = @"BY_GCDAsyncUdpSocket";
NSString *const BY_GCDAsyncUdpSocketThreadName = @"BY_GCDAsyncUdpSocket-CFStream";

enum BY_GCDAsyncUdpSocketFlags
{
...
enum BY_GCDAsyncUdpSocketConfig
{
...
@interface BY_GCDAsyncUdpSocket ()
{
	...
	BY_GCDAsyncUdpSocketReceiveFilterBlock receiveFilterBlock;
	dispatch_queue_t receiveFilterQueue;
	BOOL receiveFilterAsync;
	
	BY_GCDAsyncUdpSocketSendFilterBlock sendFilterBlock;
	...
	BY_GCDAsyncUdpSendPacket *currentSend;
...
/**
 * The BY_GCDAsyncUdpSendPacket encompasses the instructions for a single send/write.
**/
@interface BY_GCDAsyncUdpSendPacket : NSObject {
@public
	NSData *buffer;
...
@implementation BY_GCDAsyncUdpSendPacket
...
@interface BY_GCDAsyncUdpSpecialPacket : NSObject {
@public
//	uint8_t type;
...
@implementation BY_GCDAsyncUdpSpecialPacket
...
@implementation BY_GCDAsyncUdpSocket
...
- (id)initWithDelegate:(id <BY_GCDAsyncUdpSocketDelegate>)aDelegate delegateQueue:(dispatch_queue_t)dq
{
	LogTrace();
...
- (id)initWithDelegate:(id <BY_GCDAsyncUdpSocketDelegate>)aDelegate delegateQueue:(dispatch_queue_t)dq socketQueue:(dispatch_queue_t)sq
{
	LogTrace();
	...
	if ((self = [super init]))
	{
		...
		{
			socketQueue = dispatch_queue_create([BY_GCDAsyncUdpSocketQueueName UTF8String], NULL);
		}
...
- (void)setDelegate:(id <BY_GCDAsyncUdpSocketDelegate>)newDelegate synchronously:(BOOL)synchronously
{
...
- (void)setDelegate:(id <BY_GCDAsyncUdpSocketDelegate>)newDelegate
{
	[self setDelegate:newDelegate synchronously:NO];
}

- (void)synchronouslySetDelegate:(id <BY_GCDAsyncUdpSocketDelegate>)newDelegate
{
...
- (void)getDelegate:(id <BY_GCDAsyncUdpSocketDelegate> *)delegatePtr delegateQueue:(dispatch_queue_t *)delegateQueuePtr
{
	if (dispatch_get_specific(IsOnSocketQueueOrTargetQueueKey))
	{
...
- (void)setDelegate:(id <BY_GCDAsyncUdpSocketDelegate>)newDelegate delegateQueue:(dispatch_queue_t)newDelegateQueue synchronously:(BOOL)synchronously
{
	dispatch_block_t block = ^{
...
- (void)setDelegate:(id <BY_GCDAsyncUdpSocketDelegate>)newDelegate delegateQueue:(dispatch_queue_t)newDelegateQueue
{
	[self setDelegate:newDelegate delegateQueue:newDelegateQueue synchronously:NO];
}

- (void)synchronouslySetDelegate:(id <BY_GCDAsyncUdpSocketDelegate>)newDelegate delegateQueue:(dispatch_queue_t)newDelegateQueue
{
...
- (NSError *)badConfigError:(NSString *)errMsg
{
	...
	return [NSError errorWithDomain:BY_GCDAsyncUdpSocketErrorDomain
	                           code:BY_GCDAsyncUdpSocketBadConfigError
	                       userInfo:userInfo];
}
...
- (NSError *)badParamError:(NSString *)errMsg
{
	...
	return [NSError errorWithDomain:BY_GCDAsyncUdpSocketErrorDomain
	                           code:BY_GCDAsyncUdpSocketBadParamError
	                       userInfo:userInfo];
}
...
{
	NSString *errMsg = NSLocalizedStringWithDefaultValue(@"BY_GCDAsyncUdpSocketSendTimeoutError",
	                                                     @"BY_GCDAsyncUdpSocket", [NSBundle mainBundle],
	                                                     @"Send operation timed out", nil);
	
	NSDictionary *userInfo = [NSDictionary dictionaryWithObject:errMsg forKey:NSLocalizedDescriptionKey];
	
	return [NSError errorWithDomain:BY_GCDAsyncUdpSocketErrorDomain
	                           code:BY_GCDAsyncUdpSocketSendTimeoutError
	                       userInfo:userInfo];
}

- (NSError *)socketClosedError
{
	NSString *errMsg = NSLocalizedStringWithDefaultValue(@"BY_GCDAsyncUdpSocketClosedError",
	                                                     @"BY_GCDAsyncUdpSocket", [NSBundle mainBundle],
	                                                     @"Socket closed", nil);
	
	NSDictionary *userInfo = [NSDictionary dictionaryWithObject:errMsg forKey:NSLocalizedDescriptionKey];
	
	return [NSError errorWithDomain:BY_GCDAsyncUdpSocketErrorDomain code:BY_GCDAsyncUdpSocketClosedError userInfo:userInfo];
}
...
- (NSError *)otherError:(NSString *)errMsg
{
	...
	return [NSError errorWithDomain:BY_GCDAsyncUdpSocketErrorDomain
	                           code:BY_GCDAsyncUdpSocketOtherError
	                       userInfo:userInfo];
}
...
- (BOOL)createSocket4:(BOOL)useIPv4 socket6:(BOOL)useIPv6 error:(NSError * __autoreleasing *)errPtr
{
	...
	int(^createSocket)(int) = ^int (int domain) {
         ...
         *  #535(BY_GCDAsyncUDPSocket can not send data when data is greater than 9K)
         *
         *
...
- (BOOL)connectToHost:(NSString *)host onPort:(uint16_t)port error:(NSError **)errPtr
{
	...
	dispatch_block_t block = ^{ @autoreleasepool {
		...
		BY_GCDAsyncUdpSpecialPacket *packet = [[BY_GCDAsyncUdpSpecialPacket alloc] init];
...
- (void)maybeConnect
{
	...
	BOOL sendQueueReady = [currentSend isKindOfClass:[BY_GCDAsyncUdpSpecialPacket class]];
	
	if (sendQueueReady)
	{
		BY_GCDAsyncUdpSpecialPacket *connectPacket = (BY_GCDAsyncUdpSpecialPacket *)currentSend;
...
- (void)sendData:(NSData *)data withTimeout:(NSTimeInterval)timeout tag:(long)tag
{
	...
	BY_GCDAsyncUdpSendPacket *packet = [[BY_GCDAsyncUdpSendPacket alloc] initWithData:data timeout:timeout tag:tag];
...
- (void)sendData:(NSData *)data toAddress:(NSData *)remoteAddr withTimeout:(NSTimeInterval)timeout tag:(long)tag
{
	...
	BY_GCDAsyncUdpSendPacket *packet = [[BY_GCDAsyncUdpSendPacket alloc] initWithData:data timeout:timeout tag:tag];
	packet->addressFamily = [BY_GCDAsyncUdpSocket familyFromAddress:remoteAddr];
...
- (void)setSendFilter:(BY_GCDAsyncUdpSocketSendFilterBlock)filterBlock withQueue:(dispatch_queue_t)filterQueue
{
	[self setSendFilter:filterBlock withQueue:filterQueue isAsynchronous:YES];
}

- (void)setSendFilter:(BY_GCDAsyncUdpSocketSendFilterBlock)filterBlock
            withQueue:(dispatch_queue_t)filterQueue
       isAsynchronous:(BOOL)isAsynchronous
{
	BY_GCDAsyncUdpSocketSendFilterBlock newFilterBlock = NULL;
...
- (void)maybeDequeueSend
{
	...
	if (currentSend == nil)
	{
		...
		while ([sendQueue count] > 0)
		{
			...
			if ([currentSend isKindOfClass:[BY_GCDAsyncUdpSpecialPacket class]])
			{
				[self maybeConnect];
...
- (void)doPreSend
{
	...
	if (sendFilterBlock && sendFilterQueue)
	{
		...
		if (sendFilterAsync)
		{
			...
			BY_GCDAsyncUdpSendPacket *sendPacket = currentSend;
...
- (void)setReceiveFilter:(BY_GCDAsyncUdpSocketReceiveFilterBlock)filterBlock withQueue:(dispatch_queue_t)filterQueue
{
	[self setReceiveFilter:filterBlock withQueue:filterQueue isAsynchronous:YES];
}

- (void)setReceiveFilter:(BY_GCDAsyncUdpSocketReceiveFilterBlock)filterBlock
               withQueue:(dispatch_queue_t)filterQueue
          isAsynchronous:(BOOL)isAsynchronous
{
	BY_GCDAsyncUdpSocketReceiveFilterBlock newFilterBlock = NULL;
	dispatch_queue_t newFilterQueue = NULL;
...
+ (void)listenerThread
{
	@autoreleasepool {
		...
		[[NSThread currentThread] setName:BY_GCDAsyncUdpSocketThreadName];
...
+ (void)addStreamListener:(BY_GCDAsyncUdpSocket *)asyncUdpSocket
{
	LogTrace();
...
+ (void)removeStreamListener:(BY_GCDAsyncUdpSocket *)asyncUdpSocket
{
	LogTrace();
	NSAssert([NSThread currentThread] == listenerThread, @"Invoked on wrong thread");
...
{
	@autoreleasepool {
		BY_GCDAsyncUdpSocket *asyncUdpSocket = (__bridge BY_GCDAsyncUdpSocket *)pInfo;
