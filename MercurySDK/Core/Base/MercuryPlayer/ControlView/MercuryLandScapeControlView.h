...
#if __has_include(<MercuryPlayerController.h>)
...
@interface MercuryLandScapeControlView : UIView
...
/// 滑杆
@property (nonatomic, strong, readonly) MercurySliderView *slider;
...
/// 标题和全屏模式
- (void)showTitle:(NSString *_Nullable)title fullScreenMode:(MercuryFullScreenMode)fullScreenMode;
