...
#import "MercurySmallFloatControlView.h"
#if __has_include(<MercuryPlayerMediaControl.h>)
#import "MercuryPlayerMediaControl.h"
#else
#import "MercuryPlayerMediaControl.h"
#endif

@interface MercuryPlayerControlView : UIView <MercuryPlayerMediaControl>

/// 竖屏控制层的View
@property (nonatomic, strong, readonly) MercuryPortraitControlView *portraitControlView;

/// 横屏控制层的View
@property (nonatomic, strong, readonly) MercuryLandScapeControlView *landScapeControlView;

/// 用户点击控制层暂停/播放按钮回调
@property (nonatomic, copy) void(^playOrPauseBtnClickCallback)(BOOL isPause);

/// 加载loading
@property (nonatomic, strong, readonly) MercurySpeedLoadingView *activity;

/// 快进快退View
@property (nonatomic, strong, readonly) UIView *fastView;

/// 快进快退进度progress
@property (nonatomic, strong, readonly) MercurySliderView *fastProgressView;
...
/// 底部播放进度
@property (nonatomic, strong, readonly) MercurySliderView *bottomPgrogress;
...
/// 小窗口控制层
@property (nonatomic, strong, readonly) MercurySmallFloatControlView *floatControlView;
