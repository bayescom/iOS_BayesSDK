...
@protocol MercurySliderViewDelegate <NSObject>
...
@interface MercurySliderButton : UIButton

@end

@interface MercurySliderView : UIView

@property (nonatomic, weak) id<MercurySliderViewDelegate> delegate;

/** 滑块 */
@property (nonatomic, strong, readonly) MercurySliderButton *sliderBtn;
