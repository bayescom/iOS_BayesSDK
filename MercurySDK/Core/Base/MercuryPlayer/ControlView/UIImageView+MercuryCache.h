...
typedef void (^MercuryDownLoadDataCallBack)(NSData *data, NSError *error);
typedef void (^MercuryDownloadProgressBlock)(unsigned long long total, unsigned long long current);

@interface MercuryImageDownloader : NSObject<NSURLSessionDownloadDelegate>
...
@property (nonatomic, copy) MercuryDownloadProgressBlock progressBlock;
@property (nonatomic, copy) MercuryDownLoadDataCallBack callbackOnFinished;
...
typedef void (^MercuryImageBlock)(UIImage *image);

@interface UIImageView (MercuryCache)
 ...
 */
@property (nonatomic, copy) MercuryImageBlock completion;

/**
 *  Image downloader
 */
@property (nonatomic, strong) MercuryImageDownloader *imageDownloader;
