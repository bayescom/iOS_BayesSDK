//
//  UIViewController+MercuryPlayerRotation.m
//
...
@implementation UITabBarController (MercuryPlayerRotation)
...
- (NSInteger)mer_selectedIndex {
    NSInteger index = [self mer_selectedIndex];
...
@implementation UINavigationController (MercuryPlayerRotation)
